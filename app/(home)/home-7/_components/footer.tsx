    ...
    <footer className="px-4 pt-24">
      <div className="container space-y-16">
        ...
        <div className="flex flex-col gap-12 md:flex-row md:justify-between">
          {/* Col */}
          <div className="flex flex-col items-start space-y-4 md:w-1/5">
          ...
          <div className="space-y-4 md:w-2/5">
            <h4 className="font-semibold text-destructive">Useful Links.</h4>
          ...
          <div className="space-y-4 md:w-1/5">
            <h4 className="font-semibold text-destructive">Follow Us.</h4>
